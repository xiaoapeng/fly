...
function(add_jlink_image CMAKE_TARGET)
    ...
    add_custom_command(
        ...
        COMMAND ${Python3_EXECUTABLE} ${FLY_TOP_DIR}/tool/python/mk_jlink_img.py 
            ...
            --firmware-parts ${CUSTOM_FUNC_FIRMWARE_LIST} 
    ...
    if (${CMAKE_HOST_SYSTEM_NAME} MATCHES "Windows")
        ...
        add_custom_target(${CMAKE_TARGET}_flash
            COMMAND ${FLY_TOP_DIR}/image/${CUSTOM_FUNC_IMAGE_NAME}/CURRENT/burn.bat --nowait
        ...
        # 添加自定义目标 自动烧写
        add_custom_target(${CMAKE_TARGET}_flash
            COMMAND ${FLY_TOP_DIR}/image/${CUSTOM_FUNC_IMAGE_NAME}/CURRENT/burn.sh
            DEPENDS ${CMAKE_TARGET}_make_jlink_img
            COMMENT "${CUSTOM_FUNC_IMAGE_NAME}:Flashing the device with JLink"
        )
    endif()
