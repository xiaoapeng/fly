 ...
 *  配置事件回调函数的栈大小
 */
#define EH_CONFIG_EVENT_CALLBACK_FUNCTION_STACK_SIZE            (768U)
...
extern uint32_t get_timer_freq(void);
#define EH_CONFIG_CLOCKS_PER_SEC                                (get_timer_freq())
...
#   define EH_CONFIG_MEM_HEAP_SIZE                               (12*1024U)
#endif
 ...
 */
#define EH_CONFIG_INTERRUPT_STACK_SIZE                          (768U)
